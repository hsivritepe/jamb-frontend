...
export default function AiEmergencyPage() {
  ...
  async function handleSend() {
    ...
    try {
      setLoading(true);
      const resp = await fetch("/api/ai-emergency", {
        method: "POST",
  ...
  return (
    <main className="min-h-screen">
      ...
      Describe what happened (an emergency situation). We will ask clarifying questions, suggest immediate steps to take, and offer relevant services.
      </p>
      ...
      <div className="bg-white border rounded p-4 mb-4 min-h-[300px] max-h-[500px] overflow-auto">
        ...
        {messages.length === 0 && (
          <div className="text-gray-400">No messages yet. Describe your emergency!</div>
        )}
      </div>
