...
const steps = [
    {
        ...
        description:
            '<p>On our website or in the aoo, select the tvne of iob vou need: alone-time task. full-room service. or a comprehensive maintenance package. We support any task - from small fixes to large-scale renovations.</p> <p>This could be anything from mounting a shelf or replacing plumbing fixtures to a full kitchen remodel</p>',
